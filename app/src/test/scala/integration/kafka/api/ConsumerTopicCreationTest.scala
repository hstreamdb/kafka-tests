...
object ConsumerTopicCreationTest {
  ...
  private class TestCase(brokerAutoTopicCreationEnable: JBoolean, consumerAllowAutoCreateTopics: JBoolean)
    ...
    this.consumerConfig
      .setProperty(ConsumerConfig.ALLOW_AUTO_CREATE_TOPICS_CONFIG, consumerAllowAutoCreateTopics.toString)
    ...
    def test(): Unit = {
      ...
      val topicCreated = TestUtils.topicExists(createAdminClient(), topic_2)
